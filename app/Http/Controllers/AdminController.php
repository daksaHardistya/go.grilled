...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $totalPendapatan = tabel_order::whereDate('created_at', $today)
            ->where('status_order', 'digunakan')
            ->sum('total_belanjaan');

        // Hitung total pendapatan bulan ini
        $currentMonth = Carbon::now()->format('m');
        $totalPendapatanBulanIni = tabel_order::whereMonth('created_at', $currentMonth)
            ->where('status_order', 'digunakan')
            ->sum('total_belanjaan');
...
public function orderUpdate(Request $request, $id)
{
    ...
    public function pembukuanShow(Request $request)
    {
        ...
        return view('admin.pembukuan', compact(
            'transferOrders',
            'cashOrders',
            'totalTransfer',
            'totalCash',
